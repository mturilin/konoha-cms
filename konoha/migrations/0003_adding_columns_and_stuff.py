...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'konoha_page', 'published_version', self.gf('django.db.models.fields.related.ForeignKey')(db_index=True, null=True, to=orm['konoha.PageVersion']))

        # Changing field 'Page.template'
        db.add_column(u'konoha_page', 'template', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))
